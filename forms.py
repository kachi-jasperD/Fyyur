...
from wtforms import StringField, SelectField, SelectMultipleField, DateTimeField, BooleanField, IntegerField, URLField, SubmitField
...
class VenueForm(Form):
    ...
    phone = StringField(
        'phone', validators=[Length(min=11, max=14)]
    )
